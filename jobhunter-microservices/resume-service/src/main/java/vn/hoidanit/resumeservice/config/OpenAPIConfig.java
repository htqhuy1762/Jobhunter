    ...
    public OpenAPI resumeServiceOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        ...
                        .description("Resume and Job Application Management Service for JobHunter Microservices")
                        .version("1.0")
                        .contact(new Contact()
                                .name("JobHunter Team")
                ...
                .servers(List.of(
                        new Server().url("http://localhost:8084").description("Resume Service - Development"),
